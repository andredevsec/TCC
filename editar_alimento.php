...
$codigo = $_GET['cod'];
$dados = buscaAlimentoEditar($codigo);
$nome = $dados["nome"];
$valor = $dados["valor"];
    ...
    <div class="container-fluid">
        ...
        <div class="card shadow mb-2">
            <div class="card-header py-3">
                <div class="row">
                    <div class="col-md-8">
                        <h6 class="m-0 font-weight-bold text-primary" id="title">ATUALIZAR DADOS DO ALIMENTO</h6>
                    </div>
                </div>
            </div>
            <div class="card-body">
                <form class="user" action="editar_alimento_envia.php" method="post">
                    ...
                    <div class="card-footer text-muted" id="btn-form">
                        <div class="text-right">
                            <a title="Voltar" href="alimento.php"><button type="button" class="btn btn-success"><i class="fas fa-arrow-circle-left"></i>&nbsp;Voltar</button></a>
