    ...
    <div class="container-fluid">
        ...
        <div class="card shadow mb-2">
            <div class="card-header py-3">
                <div class="row">
                    <div class="col-md-8">
                        <h6 class="m-0 font-weight-bold text-primary" id="title">ADICIONAR MEDICAMENTO</h6>
                    </div>
                </div>
            </div>
            <div class="card-body">
                ...
                <form class="user" action="cad_medicamento_envia.php" method="post">
                    ...
                    <div class="card-footer text-muted" id="btn-form">
                        <div class="text-right">
                            <a title="Voltar" href="medicamento.php">
