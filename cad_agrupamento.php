    ...
    <div class="container-fluid">
        <div class="card shadow mb-2">
            <div class="card-header py-3">
                <div class="row">
                    <div class="col-md-8">
                        <h6 class="m-0 font-weight-bold text-primary" id="title">ADICIONAR NOVO AGRUPAMENTO</h6>
                    </div>
                </div>
            </div>
            <div class="card-body">
                ...
                <form action="cad_agrupamento_envia.php" method="post">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control form-control-user" id="nome" name="nome" 
                               ...
                               placeholder="Nome do agrupamento" required>
                    </div>

                    <!-- Botões -->
                    <div class="card-footer text-muted" id="btn-form">
                        <div class="text-right">
                            <a title="Voltar" href="agrupamentos.php">
                                <button type="button" class="btn btn-success">
                                    <i class="fas fa-arrow-circle-left"></i>&nbsp;Voltar
                                </button>
                            </a>
                            <button type="submit" class="btn btn-primary">
                                <i class="fas fa-fw fa-wrench"></i>&nbsp;Cadastrar
                            </button>
                        </div>
                    </div>
                </form>
