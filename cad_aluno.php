    ...
    <div class="container-fluid">
        ...
        <div class="card shadow mb-2">
            <div class="card-header py-3">
                <div class="row">
                    <div class="col-md-8">
                        <h6 class="m-0 font-weight-bold text-primary" id="title">ADICIONAR ALUNO</h6>
                    </div>
                </div>
            </div>
            <div class="card-body">
                ...
                <form class="user" action="cad_aluno_envia.php" method="post">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            <label> Curso </label>
                            <input type="text" class="form-control form-control-user" id="curso" name="curso" value="<?php if (!empty($_SESSION['curso'])) { echo $_SESSION['curso']; } ?>" placeholder="Curso" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        <div class="col-sm-6 mb-3 mb-sm-0">
                            <label> RA </label>
                            <input type="text" class="form-control form-control-user" id="ra" name="ra" value="<?php if (!empty($_SESSION['ra'])) { echo $_SESSION['ra']; } ?>" placeholder="Registro Acadêmico" required>
                        </div>
                        <div class="col-sm-6">
                            <label> Email </label>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            <label> UF </label>
                            <input type="text" class="form-control form-control-user" id="uf" name="uf" value="<?php if (!empty($_SESSION['uf'])) { echo $_SESSION['uf']; } ?>" required>
                        </div>
                    </div>
                    ...
                    <div class="card-footer text-muted" id="btn-form">
                        <div class="text-right">
                            <a title="Voltar" href="aluno.php"><button type="button" class="btn btn-success"><i class="fas fa-arrow-circle-left"></i>&nbsp;Voltar</button></a>
                            <button type="submit" name="updatebtn" class="btn btn-primary"><i class="fas fa-fw fa-user">&nbsp;</i>Adicionar</button>
                        </div>
                    </div>
                </form>  
            </div>
