-- Criando estrutura do banco de dados para controleanimais
CREATE DATABASE IF NOT EXISTS `controleanimais`;
USE `controleanimais`;

-- Criando estrutura para tabela controleanimais.aluno
...
-- Criando dados para a tabela controleanimais.aluno:
INSERT INTO `aluno` (`cod`, `nome`, `email`, `senha`, `cep`, `endereco`, `numero`, `bairro`, `cidade`, `uf`, `telefone`, `status`, `perfil`, `data`) VALUES
	(8, 'aluno1', 'aluno1@gmail.com', 'd5a8d8c7ab0514e2b8a2f98769281585', '37750000', 'aluno1', '10', 'Centro', 'Machado', 'MG', '(98) 45984-4565', 1, 2, '2024-08-07');
...
-- Criando estrutura para tabela controleanimais.servico
...
-- Criando dados para a tabela controleanimais.servico:
INSERT INTO `servico` (`cod`, `nome`, `valor`, `data`) VALUES
	(6, 'servico1', 50, '2024-08-07');

  -- Criando estrutura para tabela controleanimais.terceirizado
...
-- Criando dados para a tabela controleanimais.terceirizado:
...
-- Criando estrutura para tabela controleanimais.usuario
...
-- Criando dados para a tabela controleanimais.usuario:
...
-- Criando estrutura para tabela controleanimais.ordem
